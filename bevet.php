...
// bejelentkezett
    ...
    <html>
        <head>
            ...
            <title>leltárApp v1.0 | Termék bevételezése</title>
                ...
                <aside class="main-sidebar">
                    ...
                    <section class="sidebar">
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="active"><a href="bevet.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> <span>Termék bevételezése</span></a></li>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <h3 class="box-title">Termék bevételezése</h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body table-responsive no-padding">
                                        <form role="form" method="post" action="bevet.php">
                                            <div class="box-body">
