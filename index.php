...
<html>
    <head>
        ...
        <title>leltárApp v1.0 | Teljes lista</title>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active"><a href="index.php"><i class="fa fa-table" aria-hidden="true"></i> <span>Teljes lista</span></a></li>
                        <li><a href="bevet.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> <span>Termék bevételezése</span></a></li>
                        <li><a href="kivet.php"><i class="fa fa-minus-circle" aria-hidden="true"></i> <span>Termék kivételezése</span></a></li>
                    </ul>
                    <!-- /.sidebar-menu -->
                </section>
                <!-- /.sidebar -->
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Készletmozgások</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        ...
                                        <?php
                                        if ($result = $mysqli->query("SELECT id, termeknev, darabszam, egysegar, datum, mozgas  FROM termek")) {
                                            ...
                                            while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
                                                ...
                                                <tr>
                                                    <?php
                                                    print "<td>" . $row["id"] . "</td>";
                                                    print "<td>" . $row["termeknev"] . "</td>";
                                                    print "<td>" . $row["darabszam"] . " db</td>";
                                                    print "<td>" . $row["egysegar"] . " Ft</td>";
                                                    print "<td>" . $row["datum"] . "</td>";
                                                    print "<td>" . $row["mozgas"] . "</td>";
                                                    ?>
                                                </tr>
                                                <?php
                                            }
